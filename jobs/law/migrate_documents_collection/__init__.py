...
from job.law.utils import connect_to_databases
...
if __name__ == "__main__":
    ...
    logger.info(action="main", event="total_documents_count", count=len(documents))
    ...
    for doc in documents:
        ...
        try:
            ...
            logger.error(action="main", event="document_update_failed", **{"error.code": "DB", "error.message": str(e)}, doc_id=doc_id, exc_info=True)
